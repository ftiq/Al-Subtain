# -*- coding: utf-8 -*-
{
    ...
    'version': '1.0',
    'depends': ['appointment', 'product', 'website_appointment', 'website_sale', 'website_sale_stock', 'web', 'sale_management', 'phone_validation', 'industry_fsm', 'industry_fsm_report', 'stock', 'quality_control', 'sale_project'],
    'data': [
