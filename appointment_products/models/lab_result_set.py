    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            ...
            try:
                ...
                # احترام عدد العينات المُمرر للقوالب الخرسانية (ومنها الكور)،
                # وعدم فرضه إلى 1 إلا إذا لم يتم تمريره ولغير القير.
                try:
                    is_bitumen = False
                    ...
                    # تحديد كونها خرسانة من vals أولاً ثم من العينة
                    ...
                    if vals.get('sample_id') and not is_concrete:
                        ...
                        try:
                            ...
                            is_concrete = False
                    # إذا لم يُمرر number_of_samples أو كان <=0، نضبطه إلى 1 فقط لغير القير وغير الخرسانة
