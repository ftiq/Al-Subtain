...
class ProjectTask(models.Model):
    ...
    def action_generate_schmidt_sample_and_results(self):
        ...
        # لا نقوم بتشغيل أي حسابات تلقائية هنا ليبقى السجل في حالة "مسودة"،
        # وسيقوم المستخدم بإدخال قيم المقاومة يدوياً بما فيها معدل المقاومة.

        # لا اعتماد على إدخال يدوي للمقاومة بعد الآن
