    ...
    def _create_automatic_quality_checks(self):
        ...
        for move_line in self.move_line_ids:
            ...
            if is_concrete and (move_line.group_no or move_line.age_days or move_line.cube_count):
                ...
                # إنشاء مفتاح المجموعة بالرموز الفعلية من المهمة
                ...
                if group_key not in concrete_products_data[product.id]['groups']:
                    concrete_products_data[product.id]['groups'][group_key] = {
                        ...
                        'field_code': move_line.field_code,  # استخدام الرمز الفعلي من المهمة
                        'field_serial': move_line.field_serial,  # استخدام الرقم الفعلي من المهمة
        ...
        if not products_without_templates:
            self.message_post(body="تم إشعار المختبر بنجاح")
