...
class SchmidtReadingsWizard(models.TransientModel):
    ...
    point_id = fields.Many2one(
        ...
        string='النقطة', required=True, ondelete='cascade')

    r1 = fields.Float(string='قراءة 1')
    r2 = fields.Float(string='قراءة 2')
    r3 = fields.Float(string='قراءة 3')
    r4 = fields.Float(string='قراءة 4')
    r5 = fields.Float(string='قراءة 5')
    r6 = fields.Float(string='قراءة 6')
    r7 = fields.Float(string='قراءة 7')
    r8 = fields.Float(string='قراءة 8')
    r9 = fields.Float(string='قراءة 9')
    r10 = fields.Float(string='قراءة 10')

    rn_avg_preview = fields.Float(string='معدل الارتداد (معاينة)', compute='_compute_preview', digits=(16, 2))
    ...
    def default_get(self, fields_list):
        ...
        if point_id:
            ...
            # Prefill from previous readings if any
